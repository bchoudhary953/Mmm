...
public class MainActivity extends AppCompatActivity {
	...
	private void setupViewPager(ViewPager viewPager) {
		...
		adapter.addFragment(new AlarmFragment(),"One");
		adapter.addFragment(new AnalysisFragment(),"two");
	...
	protected void onResume() {
		super.onResume();
		if(Utils.isMyServiceRunning(AlarmSound.class, context) && !isDialogShowing){
			Log.d("Running: ", "TRUE");
			showAlarmDialog();
		}
	}
